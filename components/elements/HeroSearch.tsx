			...
			<div className="box-bottom-search background-card">
				<div className="item-search">
					...
					<Dropdown className="dropdown">
						<Dropdown.Toggle as="div" className="btn btn-secondary dropdown-toggle btn-dropdown-search location-search"  aria-expanded="false">Fumba, Zanzibar</Dropdown.Toggle>
						<Dropdown.Menu as="ul" className="dropdown-menu">
							<li>
								<Link className="dropdown-item" href="#">Chaani, Zanzibar</Link>
							</li>
							<li>
								<Link className="dropdown-item" href="#">Mbweni, Zanzibar</Link>
							</li>
							<li>
								<Link className="dropdown-item" href="#">Changani, Zanzibar</Link>
							</li>
						</Dropdown.Menu>
					</Dropdown>
				</div>
				<div className="item-search item-search-2">
					...
					<Dropdown className="dropdown">
						<Dropdown.Toggle as="div" className="btn btn-secondary dropdown-toggle btn-dropdown-search location-search" >Stone Town, Zanzibar</Dropdown.Toggle>
						<Dropdown.Menu as="ul" className="dropdown-menu">
							<li>
								<Link className="dropdown-item" href="#">Forodhani Street, Zanzibar</Link>
							</li>
							<li>
								<Link className="dropdown-item" href="#">Nungwi, Zanzibar</Link>
							</li>
							<li>
								<Link className="dropdown-item" href="#">Stone Town, Zanzibar</Link>
							</li>
						</Dropdown.Menu>
					</Dropdown>
				</div>
