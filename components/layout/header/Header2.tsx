					...
					<div className="container-fluid">
						<div className="text-header-info">
							...
							<Link className="email-head text-white" href="/tel:123-456-7890">
								...
								<span className="d-none d-lg-inline-block">vemacars.com</span>
							</Link>
						</div>
