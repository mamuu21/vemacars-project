...
export default function Header1({ scroll, isMobileMenu, handleMobileMenu, handleOffcanvas, isOffcanvas }: any) {
	return (
		<>
			<header className={`header header-fixed sticky-bar ${scroll ? 'stick' : 'header-transparent'}`}>
					...
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">+255 780-555-339</span>
							</Link>
							<Link className="email-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">vemacars@gmail.com</span>
							</Link>
						</div>
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
										...
										<li>
											<Link className="color-white" href="/cars-list-3">Car List</Link>
										</li>
										<li>
											<Link className="color-white" href="#">My Bookings</Link>
										</li>
